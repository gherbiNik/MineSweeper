...
public class GameBoardViewFxml implements ControlledFxView {
    ...
    private void populateCellsMatrix() {
        ...
        cells[1][6] = cell16; cells[1][7] = cell17; cells[1][8] = cell18;

        cells[2][0] = cell20; cells[2][1] = cell21; cells[2][2] = cell22;
        cells[2][3] = cell23; cells[2][4] = cell24; cells[2][5] = cell25;
        cells[2][6] = cell26; cells[2][7] = cell27; cells[2][8] = cell28;

        cells[3][0] = cell30; cells[3][1] = cell31; cells[3][2] = cell32;
        cells[3][3] = cell33; cells[3][4] = cell34; cells[3][5] = cell35;
        cells[3][6] = cell36; cells[3][7] = cell37; cells[3][8] = cell38;

        cells[4][0] = cell40; cells[4][1] = cell41; cells[4][2] = cell42;
        cells[4][3] = cell43; cells[4][4] = cell44; cells[4][5] = cell45;
        cells[4][6] = cell46; cells[4][7] = cell47; cells[4][8] = cell48;

        cells[5][0] = cell50; cells[5][1] = cell51; cells[5][2] = cell52;
        cells[5][3] = cell53; cells[5][4] = cell54; cells[5][5] = cell55;
        cells[5][6] = cell56; cells[5][7] = cell57; cells[5][8] = cell58;

        cells[6][0] = cell60; cells[6][1] = cell61; cells[6][2] = cell62;
        cells[6][3] = cell63; cells[6][4] = cell64; cells[6][5] = cell65;
        cells[6][6] = cell66; cells[6][7] = cell67; cells[6][8] = cell68;

        cells[7][0] = cell70; cells[7][1] = cell71; cells[7][2] = cell72;
        cells[7][3] = cell73; cells[7][4] = cell74; cells[7][5] = cell75;
        cells[7][6] = cell76; cells[7][7] = cell77; cells[7][8] = cell78;

        cells[8][0] = cell80; cells[8][1] = cell81; cells[8][2] = cell82;
        cells[8][3] = cell83; cells[8][4] = cell84; cells[8][5] = cell85;
        cells[8][6] = cell86; cells[8][7] = cell87; cells[8][8] = cell88;
    }
